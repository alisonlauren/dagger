...
/* Add Class Active To Nav Bar Search */
...
if (window.location.hash === '#recover') { showRecoverPasswordForm(); }
  ...
  if ( $(window).width() > 767) {      
$( ".template-index .product-thumbnail" )
  .mouseenter(function() {
    $(".product-thumbnail").css('opacity', '0.2');
    $(this).css('opacity', '1');
  })
  .mouseleave(function() {
    $(".product-thumbnail").css('opacity', '1');
  });
    $(document)
      .ready(function() {

        // fix main menu to page on passing
        $('.product-sticky').visibility({
          type: 'fixed'
        });
      });
  } 